...
%%%%%%%%%%%%% local definitions %%%%%%%%%%%%%%%%%%%%%
\newcommand{\mytitle}{PCC luminosity linearity studies with high pile-up data}
...
\abstract{
   Studies are presented on the relative linearity of the PCC, PLT, BCM1F, and HF-OC luminometers using special high pile-up proton-proton data from the 2018 LHC runs.
}
