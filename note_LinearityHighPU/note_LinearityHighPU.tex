...
%%%%%%%%%%%%% local definitions %%%%%%%%%%%%%%%%%%%%%
\newcommand{\mytitle}{PCC linearity studies with high pile-up p-p collisions}
...
\abstract{
  This note documents studies on the relative linearity of the PCC and other luminometers using special high pile-up proton-proton data from the 2018 LHC runs.
  A wide range of pile-up is tested between 5 and 100 using scans in fills 6847 and 7358.
}
