...
process.PCCProd = cms.EDProducer("PCCProducer",
    PCCProducerParameters = cms.PSet(
        ...
        outputProductName = cms.untracked.string("PCCRandom"), 
        modVeto=cms.vint32()
    )    
)
...
process.path1 = cms.Path(process.PCCProd+process.corrPCCProd+process.dqmEnvLumiPCC)
