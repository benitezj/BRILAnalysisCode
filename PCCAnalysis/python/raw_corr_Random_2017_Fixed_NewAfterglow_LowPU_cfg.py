...
vetofilename = os.getenv('CMSSW_BASE')+'/src/BRILAnalysisCode/PCCAnalysis/test/vetoModules_2017_fixed_W0_FPIXD05_Bkg25_lowPU_W0_Stab0p02.txt'
...
process.corrPCCProd = DQMEDAnalyzer("CorrPCCProducerReRecoLowPU",
      CorrPCCProducerReRecoLowPUParameters = cms.PSet(
         ...
         type1Frac= cms.double(0.02381),
         type2_a= cms.double(0.001001),
         type2_b= cms.double(0.01783),
...
process.corrPCCProd.CorrPCCProducerReRecoLowPUParameters.run = cms.int32(int(runnumber))
