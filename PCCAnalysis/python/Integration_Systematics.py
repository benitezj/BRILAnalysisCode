...
for i in range(num_bin):
        ...
        hist_h_ratio.SetPoint(hist_h_ratio.GetN(), ProfX_h_ratio.GetBinContent(i), hist_HFOC_perls.GetBinContent(i)/1000)
        print ProfX_h_ratio.GetBinContent(i), hist_HFOC_perls.GetBinContent(i)/1000
...
hist_h_ratio.SetTitle("PCC/HFOC vs HFOC lumi")
...
ProjY_ProfX_h_ratio.GetYaxis().SetRangeUser(0, 35)
