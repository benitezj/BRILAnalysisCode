...
void AN_21_022_plots() {
  ...
  gROOT->ProcessLine(".x /afs/cern.ch/user/a/asehrawa/Reprocessed_PCC_2018_data/CMSSW_10_2_2/src/BRILAnalysisCode/PCCAnalysis/plots//rootlogon.C");
  ...
  std::vector<int> run_number = {319019, 319077, 319097, 319098, 319099, 319100, 319101, 319103, 319104, 319124, 319125, 319159, 319160,319173, 319174, 319175, 319176, 319177, 319190, 319222, 319223, 319254, 319255, 319256, 319260, 319262, 319263, 319264, 319265, 319266, 319267, 319268, 319270, 319273, 319274, 319300, 319310, 319311};

  std::cout<<run_number.size()<<std::endl;
  readModRPhiZCoordinates();

  readModVeto("/afs/cern.ch/user/a/asehrawa/Reprocessed_PCC_2018_data/CMSSW_10_2_2/src/BRILAnalysisCode/PCCAnalysis/plots/veto_common_1701.txt");
  ...
  histo_L2=new TH2F("Histo_Layer2","",200,0,300000,300,0,0.15);
  histo_L3=new TH2F("Histo_Layer3","",200,0,300000,300,0,0.15);
  histo_L4=new TH2F("Histo_Layer4","",200,0,300000,300,0,0.15);
  histo_D1=new TH2F("Histo_Disk1","",200,0,300000,300,0,0.15);
  histo_D2=new TH2F("Histo_Disk2","",200,0,300000,300,0,0.15);
  histo_D3=new TH2F("Histo_Disk3","",200,0,300000,300,0,0.15);
  ...
  histo_L2->GetXaxis()->SetTitle("Date [Day/Month]");
  ...
  auto legend = new TLegend(0.7,0.4,0.89,0.7);
