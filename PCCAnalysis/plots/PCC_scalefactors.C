void PCC_scalefactors() {
  ...
  H2 = (TH1F*)f1->Get("ScaleFactorsAvg_315690_10_513_563;1");
  H2->SetLineColor(2);
  H2->SetMarkerColor(2);
  if (H2==NULL){
    return;
  ...
  H1->SetTitle("Scale factors ratio for colliding bunches (run 315690 LS block 563)");
  //H1->SetTitle("Scale factors (run 315690 LS block 563)"); 
  ...
  C->Print("/eos/user/a/asehrawa/BRIL-new/scalefactors_old_new_as_jb_RunA_ratio.root");
}
