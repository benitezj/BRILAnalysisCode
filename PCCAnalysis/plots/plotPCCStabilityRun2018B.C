...
#include <string>
#include <TLegend.h>
void plotPCCStabilityRun2018B() {
    
  TString inpath40 = "/afs/cern.ch/user/a/asehrawa/www/BRIL-PCC/veto_lateRunD_lowcut_tight/Run2018B";

  TString inpath="/eos/user/a/asehrawa/B1/Run2018B";
  TString inpath3="/eos/user/a/asehrawa/B2/Run2018B";
  TString inpath6="/eos/user/a/asehrawa/B3/Run2018B";
  TString inpath9="/eos/user/a/asehrawa/F1/Run2018B";
  TString inpath12="/eos/user/a/asehrawa/F2/Run2018B";
  TString inpath15="/eos/user/a/asehrawa/F3/Run2018B";
  TString ref="";
  ...
  TH2F H40("H40","", 200,0,60000,300,0,0.35);

  TH2F H("H","", 200,0,60000,300,0,0.35);
  TH2F H3("H3","", 200,0,60000,300,0,0.35);
  TH2F H6("H6","", 200,0,60000,300,0,0.35);
  TH2F H9("H9","", 200,0,60000,300,0,0.35);
  TH2F H12("H12","", 200,0,60000,300,0,0.35);
  TH2F H15("H15","", 200,0,60000,300,0,0.35);
  ...
  P->GetYaxis()->SetTitle(" lumi fraction (per 300 lumi sections) ");
