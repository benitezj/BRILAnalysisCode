...
void comparePCCLumi_allruns(){
  ...
  for (unsigned int j=0;j<run_number.size();j++){
    ...
    //TString Path1="/eos/user/a/asehrawa/BRIL-new/PCC_reprocess_2018B_newveto/ZeroBias/Run2018B_ZB";
    TString Path1="/eos/user/a/asehrawa/BRIL-new/PCC_reprocess_2018C_newveto/ZeroBias/Run2018C_ZB";
    ...
    //HCSV->GetYaxis()->SetRangeUser(0, 3500000);
    ...
    C.Print(Path+TString("csv_file_lumi_comparison_RunC")+".root");
