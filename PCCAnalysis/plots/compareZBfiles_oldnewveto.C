...
void compareZBfiles_oldnewveto(char run_period='D') {
  ...
  for (unsigned int j=0;j<run_number.size();j++){
    ...
    if(run_period=='A'){
      Path3 = "/eos/user/a/asehrawa/PCC/EXPRESS_datasets/ZeroBias/Run2018_ZB_test/Run2018A";
    }
    if(run_period=='B'){
      Path3 = "/eos/user/a/asehrawa/PCC/EXPRESS_datasets/ZeroBias/Run2018_ZB_test/Run2018B";
    }
    if(run_period=='C'){
      Path3 = "/eos/user/a/asehrawa/PCC/EXPRESS_datasets/ZeroBias/Run2018_ZB_test/Run2018C";
    } 
    if(run_period=='D'){
      Path3 = "/eos/user/a/asehrawa/PCC/EXPRESS_datasets/ZeroBias/Run2018_ZB_test/Run2018D1";
    }
    if(run_period=='E'){   
      Path3 = "/eos/user/a/asehrawa/PCC/EXPRESS_datasets/ZeroBias/Run2018_ZB_test/Run2018D2";
    }
    if(run_period=='F'){
      Path3 = "/eos/user/a/asehrawa/PCC/EXPRESS_datasets/ZeroBias/Run2018_ZB_test/Run2018D3";
    }
    if(run_period=='G'){    
      Path3 = "/eos/user/a/asehrawa/PCC/EXPRESS_datasets/ZeroBias/Run2018_ZB_test/Run2018D4";
    }


    TString infile1=Path3+"/"+run_number.at(j)+".csv";
    //std::cout<< run_number.at(j)<<std::endl;                                                                                               
