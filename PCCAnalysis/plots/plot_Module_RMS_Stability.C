...
//TString ModVeto = "BRILAnalysisCode/PCCAnalysis/veto_2022/veto_2022FStab2p08pLin04p025p_2022CStab2p1pLin04p03p_2022EStab06pLin03p_2022GStab06pLin03p_DStab06pLin03p.txt";



//#define NTOTALLS 35000
...
void plot_Module_RMS_Stability() {  
  ...
  TH2D* histo_L1=new TH2D("Histo_Layer1","",NTOTALLS/NLSBLOCK,0,NTOTALLS,2000,0,0.5);
  TH2D* histo_L2=new TH2D("Histo_Layer2","",NTOTALLS/NLSBLOCK,0,NTOTALLS,2000,0,0.5);
  TH2D* histo_L3=new TH2D("Histo_Layer3","",NTOTALLS/NLSBLOCK,0,NTOTALLS,2000,0,0.5);
  TH2D* histo_L4=new TH2D("Histo_Layer4","",NTOTALLS/NLSBLOCK,0,NTOTALLS,2000,0,0.5);
  TH2D* histo_D1S1=new TH2D("Histo_Disk1S1","",NTOTALLS/NLSBLOCK,0,NTOTALLS,2000,0,0.5);
  TH2D* histo_D2S1=new TH2D("Histo_Disk2S1","",NTOTALLS/NLSBLOCK,0,NTOTALLS,2000,0,0.5);
  TH2D* histo_D3S1=new TH2D("Histo_Disk3S1","",NTOTALLS/NLSBLOCK,0,NTOTALLS,2000,0,0.5);
  TH2D* histo_D1S2=new TH2D("Histo_Disk1S2","",NTOTALLS/NLSBLOCK,0,NTOTALLS,2000,0,0.5);
  TH2D* histo_D2S2=new TH2D("Histo_Disk2S2","",NTOTALLS/NLSBLOCK,0,NTOTALLS,2000,0,0.5);
  TH2D* histo_D3S2=new TH2D("Histo_Disk3S2","",NTOTALLS/NLSBLOCK,0,NTOTALLS,2000,0,0.5);
 ...
 if(makePerLayerPlots){
   ...
   P_L3->GetYaxis()->SetTitle("Layer/Disk  Weight");
