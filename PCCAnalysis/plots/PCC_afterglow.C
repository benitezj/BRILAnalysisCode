void PCC_afterglow() {
  ...
  TFile*f = new TFile("/eos/cms/store/cmst3/user/benitezj/BRIL/PCC/AlCaPCCRandom/316110.root");
  TFile*f1 = new TFile("/eos/user/a/asehrawa/BRIL-new/PCC_reprocess_2018A_newveto_RD/AlCaPCCRandom/Run2018A/316110.root");
  ...
  H1->GetYaxis()->SetRangeUser(1, 1.6); 
  H1->Divide(H2);
  H1->Draw("p");
  //H2->Draw("psame");
  ...
  //C->Print("/eos/user/a/asehrawa/BRIL-new/Raw_corr_histogram_new_as_RunC.png");
