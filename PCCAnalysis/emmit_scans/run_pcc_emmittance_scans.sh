...
python3 ${CMSSW_BASE}/src/BRILAnalysisCode/PCCAnalysis/emmit_scans/tuple_to_hd5_emmittance.py --inputfile=./pcctuple.root  --moduleveto=${CMSSW_BASE}/src/BRILAnalysisCode/PCCAnalysis/veto_2025/veto_B0+wights0+Block1_Sty1_Sty2+Block2_Sty1_Sty2+Block3_Sty1+Block4_Sty1+vdM_SS1cut_SS4cut+Lty_11229+Lty_10857.txt --timestamps=${CMSSW_BASE}/src/BRILAnalysisCode/PCCAnalysis/emmit_scans/emmit_scantimes_2025.txt
