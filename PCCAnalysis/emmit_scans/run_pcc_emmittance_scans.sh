...
python3 ${CMSSW_BASE}/src/BRILAnalysisCode/PCCAnalysis/emmit_scans/tuple_to_hd5_emmittance.py --inputfile=./pcctuple.root  --moduleveto=${CMSSW_BASE}/src/BRILAnalysisCode/PCCAnalysis/veto_2024/veto_B0+vdMBgdSS1_SS2_wights0+vdMSty+Block1_Sty1_Sty2_+Block2_Sty1_Sty2+Block3_Sty1_Sty2+Block4_Sty1_Sty2+Block5_Sty1_Sty2+Block6_Sty1_Sty2+All_Blocks_Sty_Lty.txt
