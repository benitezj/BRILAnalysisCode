...
#baseoutdir=/eos/user/l/lcuevasp/BRIL/PCC/VDM
#baseoutdir=/eos/user/l/lcuevasp/BRIL/PCC/VDM_test_2022
...
make_sh_script(){
    ...
    echo "python  /afs/cern.ch/user/l/lcuevasp/CMSSW/CMSSW_10_6_29/src/BRILAnalysisCode/PCCAnalysis/vdM/pccminitree_to_hd5.py --minitreefile=./pccVdmMiniTree.root" >> $fullsubmitdir/${run}.sh
